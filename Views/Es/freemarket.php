...
<body>
    ...
    <section>
        ...
        <div class="container-fluid inner-color front-section" id="usos">
            <div class="container">
                <div class="row">
                    <div class="section-title">
                        <h2>P2P xRhodium<br />Mercado de METALES y mas</h2>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="home-about">
                            <p>
                                Para estimular la inversiont, fortalecer el proposito de uso de xRhodium y promover la adopcion de criptomonedas, estamos trabajando en una aplicacion qude completara el vacio entre las inversiones en cripto y las tradiciona <strong></strong>. Facilitara el intercambio persona a persona entre XRC y <strong>y los mercados de metales preciosos</strong> a traves de la interaccion decentralizada y efficiente de compradores y vendedores sin intermediarios.
                            </p>
                            <p>Mas informacion pronto... <a href="https://www.fmone.org" target="_blank" onclick="gtag('event', 'click', { event_category: 'button', event_action: 'click', event_label: 'freedom'});"><strong>www.fmone.org</strong></a>.</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="front-thumb" data-aos="fade-up">
                        ...
                        <div class="thumb-caption">
                            ...
                            <p>BEl uso de xRhodium satisface el vacio en el mercado de criptomonedas y junto a BTC y LTC forma un eficiente ecosistema, la Trinidad Cripto, que satisface las necesidades de la mayoria de los inversores.</p>
                            <div class="btn-box">
                                <p>
